...
/* 0 if you don't want axi-blaster driver. */
#define BUILD_AXIBLASTER 1
...
#define PACKAGE_STRING "openocd 0.12.0-rc1"
...
#define PACKAGE_VERSION "0.12.0-rc1"
